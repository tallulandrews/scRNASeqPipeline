...
NUMFILES=${#INPUTFILES[@]}
MAXJOBS=$(($NUMFILES/2))
bsub -J"mappingwithstararrayjob[1-$MAXJOBS]%50" -R"select[mem>5000] rusage[mem=5000] span[hosts=1]" -M5000 -n2 -q normal -o output.%J.%I /nfs/users/nfs_t/ta6/RNASeqPipeline/2-5.2_Salmon_quant.sh 1 $INPUTDIR $OUPUTDIR $INDEXFILE $GTFFILE
